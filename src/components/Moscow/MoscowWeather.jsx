...
import './MoscowWeather.css';
import * as request from 'superagent'
import { APIweather, moscow } from '../../const';
...
export default class AmsterdamWeather extends Component {
  ...
  fetchData = () => {
    request
    .get(`http://api.openweathermap.org/data/2.5/forecast?id=${moscow}&APPID=${APIweather}`)
    ...
    return (
      <div>
        <div className="weather-bar-container">
          <div className="moscow-weather-bar" style={{height:`${this.state.height}px`}} ></div>
        </div>
      </div>
    )
  }
